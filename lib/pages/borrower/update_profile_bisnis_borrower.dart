...
import 'package:lendyv1/pages/borrower/tambah_profile_bisnis.dart';

class UpdateProfilBisnisBorrower extends StatefulWidget {
  UpdateProfilBisnisBorrower({Key? key}) : super(key: key);

  @override
  _UpdateProfilBisnisBorrowerState createState() =>
      _UpdateProfilBisnisBorrowerState();
}

class _UpdateProfilBisnisBorrowerState
    extends State<UpdateProfilBisnisBorrower> {
