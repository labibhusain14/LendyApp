...
import 'package:lendyv1/pages/investor/update_profil_pribadi_investor.dart';

class ProfilPribadiInvestor extends StatefulWidget {
  ProfilPribadiInvestor({Key? key}) : super(key: key);

  @override
  _ProfilPribadiInvestor createState() => _ProfilPribadiInvestor();
}

class _ProfilPribadiInvestor extends State<ProfilPribadiInvestor> {
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.of(context)
                    ...
                    return UpdateProfilPribadiInvestor();
                  }));
                },
                child: Text(
